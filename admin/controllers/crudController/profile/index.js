...
exports.create = async (Profile, req, res) => {
    try {
        ...
        console.log('Error in create profile ', err.message)
        return res.status(200).json({
            success: true,
            result: null,
            message: `Failed to create Profile`,
...
//     phone: reqData.phone,
//     bio: reqData.bio,
//     facebook_link: reqData.facebook_link,
//     instagram_link: reqData.instagram_link,
//     youtube_link: reqData.youtube_link,
//     blog_link: reqData.blog_link,
//     interests: reqData.interests,
//     profile_picture_url: reqData.profile_picture_url,
//     profile_banner_url: reqData.profile_banner_url,
// }
