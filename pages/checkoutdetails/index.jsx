                                ...
                                <div style={{ "fontsize": "12px", color: "#000000" }}>
                                    <div style={{ width: "680px", margin: "0 auto" }} className="receipt-table">
                                        ...
                                        <table style={{ borderCollapse: "collapse", width: "100%", borderTop: "1px solid #DDDDDD", borderLeft: "1px solid #DDDDDD", marginBottom: "20px" }}>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "left", padding: "7px" }}><b>Order ID:</b> 1426536<br />
                                                        <b>Date Added:</b> 12/20/2022<br />
                                                        <b>Payment Method:</b> Mail a Check/PO<br />
                                                        <b>Delivery Date:</b> Fri 23 Dec, 2022<br />
                                                    </td>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "left", padding: "7px" }}><b>Email:</b> adsfsdfsdfadf@gmail.com<br />
                                                        <b>Telephone:</b> qwerqewr<br />
                                                        <b>IP Address:</b> 10.25.2.33<br />
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table style={{ borderCollapse: "collapse", width: "100%", borderTop: "1px solid #DDDDDD", borderLeft: "1px solid #DDDDDD", marginBottom: "20px" }}>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "left", padding: "7px" }}>erwqewrqwer qewrqwer<br />qewrqwerqwe<br />rqewrqewr<br />wweqrw<br />qwerwq werew<br />Nord-Trondelag<br />Norway</td>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "left", padding: "7px" }}>erwqewrqwer qewrqwer<br />qewrqwerqwe<br />rqewrqewr<br />wweqrw<br />qwerwq werew<br />Nord-Trondelag<br />Norway</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        <table style={{ borderCollapse: "collapse", width: "100%", borderTop: "1px solid #DDDDDD", borderLeft: "1px solid #DDDDDD", marginBottom: "20px" }}>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "left", padding: "7px" }}>Standard Edition Truck Cover                    <br />
                                                        ...
                                                        <br />
                                                        &nbsp;<small> - Body: Dual Cab with 5.5ft Short Bed and Camper Shell</small>
                                                    </td>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "left", padding: "7px" }}>CARCF-11</td>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "right", padding: "7px" }}>1</td>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "right", padding: "7px" }}>$154.95</td>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "right", padding: "7px" }}>$154.95</td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "right", padding: "7px" }}><b>Delivery date Fri 23 Dec, 2022:</b></td>
                                                    <td style={{ fontSize: "12px", borderRight: "1px solid #DDDDDD", borderBottom: "1px solid #DDDDDD", textAlign: "right", padding: "7px" }}>$0.00</td>
                                                </tr>
                                                <tr>
